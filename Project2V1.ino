...
const int rightSpeed = 5; //means pin 9 on the Arduino controls the speed of left motor
...
const int topSpeed = 50; //max PWM value written to motor speed pin. It is typically 255.
...
if(output>setpoint){
  rightSpeedVal=topSpeed+20;
  leftSpeedVal=minSpeed;
}
else if(output<setpoint){
   leftSpeedVal=topSpeed;
